<?php $__env->startSection('page_title', 'Paramètres'); ?>
<?php $__env->startSection('title_icon', '⚙️'); ?>
<?php $__env->startSection('breadcrumb'); ?> Paramètres <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>


<form method="POST" action="<?php echo e(route('admin.settings.paypal')); ?>">
<?php echo csrf_field(); ?>
<div class="ps-panel">
    <div class="ps-panel-header">
        <span class="ps-icon">💳</span> Paiement PayPal
        <div class="ps-panel-tools">
            <span class="ps-badge <?php echo e(($paypal['paypal_mode'] ?? 'sandbox') === 'live' ? 'ps-badge-success' : 'ps-badge-warning'); ?>">
                <?php echo e(strtoupper($paypal['paypal_mode'] ?? 'SANDBOX')); ?>
    ...
    <div class="ps-panel-body">
        ...
        <div class="ps-form-group">
            ...
            <select name="paypal_mode" class="ps-select" style="max-width:200px">
                <option value="sandbox" <?php echo e(($paypal['paypal_mode'] ?? 'sandbox') === 'sandbox' ? 'selected' : ''); ?>>Sandbox (test)</option>
                <option value="live"    <?php echo e(($paypal['paypal_mode'] ?? '') === 'live' ? 'selected' : ''); ?>>Live (production)</option>
            </select>
        </div>
        ...
        <div class="ps-grid-2">
            <div class="ps-form-group">
                ...
                <input type="text" name="paypal_client_id" class="ps-input"
                       value="<?php echo e($paypal['paypal_client_id'] ?? ''); ?>"
            ...
            <div class="ps-form-group">
                ...
                <input type="password" name="paypal_client_secret" class="ps-input"
                       value="<?php echo e($paypal['paypal_client_secret'] ?? ''); ?>"
                       placeholder="••••••••••••••••"
        ...
        <div class="ps-form-group">
            ...
            <input type="text" name="paypal_webhook_id" class="ps-input"
                   value="<?php echo e($paypal['paypal_webhook_id'] ?? ''); ?>"
        ...
        <div class="ps-grid-2">
            <div class="ps-form-group">
                ...
                <input type="url" name="paypal_return_url" class="ps-input"
                       value="<?php echo e($paypal['paypal_return_url'] ?? ''); ?>"
            ...
            <div class="ps-form-group">
                ...
                <input type="url" name="paypal_cancel_url" class="ps-input"
                       value="<?php echo e($paypal['paypal_cancel_url'] ?? ''); ?>"
...
<form method="POST" action="<?php echo e(route('admin.settings.company')); ?>">
<?php echo csrf_field(); ?>
<div class="ps-panel">
    <div class="ps-panel-header">
    ...
    <div class="ps-panel-body">
        ...
        <div class="ps-form-group">
            ...
            <input type="text" name="company_address" class="ps-input"
                   value="<?php echo e($company['company_address'] ?? ''); ?>"
        ...
        <div class="ps-grid-3">
            ...
            <div class="ps-form-group">
                ...
                <input type="text" name="company_uid" class="ps-input"
                       value="<?php echo e($company['company_uid'] ?? ''); ?>"
        ...
        <div class="ps-form-group">
            ...
            <input type="text" name="company_iban" class="ps-input"
                   value="<?php echo e($company['company_iban'] ?? ''); ?>"
        ...
        <div class="ps-grid-2">
            <div class="ps-form-group">
                ...
                <select name="company_vat_exempt" class="ps-select">
                    <option value="true"  <?php echo e(($company['company_vat_exempt'] ?? 'true') === 'true'  ? 'selected' : ''); ?>>Exonéré (CA &lt; 100 000 CHF/an)</option>
                    <option value="false" <?php echo e(($company['company_vat_exempt'] ?? 'true') === 'false' ? 'selected' : ''); ?>>Assujetti à la TVA</option>
                </select>
            </div>
            <div class="ps-form-group">
                ...
                <input type="text" name="company_vat_number" class="ps-input"
                       value="<?php echo e($company['company_vat_number'] ?? ''); ?>"
...
<?php echo $__env->make('admin.layouts.prestashop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>