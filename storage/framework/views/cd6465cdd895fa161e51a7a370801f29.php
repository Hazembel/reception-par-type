    ...
    <div class="w-full max-w-md mx-auto">
        <div class="overflow-hidden rounded-[2rem] bg-white/95 dark:bg-marine-900/80
            ...
            <div class="flex flex-col items-center text-center space-y-2 mb-8">
                ...
                <h1 class="text-lg font-semibold text-slate-900 dark:text-white">Créer un compte</h1>
            ...
            <form method="POST" action="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>" novalidate>
                <?php echo csrf_field(); ?>

                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Nom complet</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4" x-data="{ show: false }">
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Mot de passe</label>
                    <div class="relative">
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="mt-6 text-center text-xs text-slate-500 dark:text-slate-400">
                Déjà un compte ?
                <a href="<?php echo e(route('login', ['locale' => app()->getLocale()])); ?>" class="font-medium text-blue-600 dark:text-astra hover:underline">Se connecter</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/auth/register.blade.php ENDPATH**/ ?>