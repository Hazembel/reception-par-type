...
<div class="pt-20 pb-16 max-w-3xl mx-auto px-4 sm:px-6">
    <h1 class="font-display text-2xl text-slate-900 dark:text-white mb-8"><?php echo e($meta_title ?? __('app.legal.mentions_title')); ?></h1>
    ...
    <div class="prose dark:prose-invert text-slate-600 dark:text-slate-300 text-sm space-y-8">
        ...
        <section>
            ...
            <p>
                <strong>Raison sociale :</strong> <?php echo e(\App\Models\Setting::get('company_name', 'reception-par-type.ch Sàrl')); ?><br>
                <strong>Forme juridique :</strong> Société à responsabilité limitée (Sàrl)<br>
                <strong>Adresse :</strong> <?php echo e(\App\Models\Setting::get('company_address', 'Rue de Genève 1')); ?>, <?php echo e(\App\Models\Setting::get('company_postal', 'CH-1003')); ?> <?php echo e(\App\Models\Setting::get('company_city', 'Lausanne')); ?>, Suisse<br>
                ...
                <?php if(\App\Models\Setting::get('company_uid')): ?>
                <br><strong>IDE/UID :</strong> <?php echo e(\App\Models\Setting::get('company_uid')); ?>
        ...
        <section>
            ...
            <p>Le directeur de la publication est le représentant légal de <?php echo e(\App\Models\Setting::get('company_name', 'reception-par-type.ch Sàrl')); ?>.</p>
        </section>
        ...
        <section>
            ...
            <p>
                Ce site peut contenir des liens vers des sites tiers. <?php echo e(\App\Models\Setting::get('company_name', 'reception-par-type.ch Sàrl')); ?> n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu.
            </p>
        </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/legal/mentions.blade.php ENDPATH**/ ?>