...
<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" class="ps-admin">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <title><?php echo $__env->yieldContent('page_title', 'Administration'); ?> · reception-par-type.ch</title>
...
<div class="ps-layout"
     x-data="{
        collapsed: false,
        mobileOpen: false,
        openMenu: '<?php echo e($activeMenu ?? ''); ?>',
    ...
    <div class="ps-main">
        ...
        <header class="ps-header">
            ...
            <div class="ps-header-actions">
                <a href="<?php echo e(url('/fr')); ?>" target="_blank" class="ps-header-btn">
                    <span>🔗</span> Voir le site
                </a>
                <div class="ps-avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A', 0, 1))); ?></div>
            </div>
        </header>
        ...
        <div class="ps-pagebar">
            ...
            <h1 class="ps-page-title">
                <?php if (! empty(trim($__env->yieldContent('title_icon')))): ?><span class="ps-icon"><?php echo $__env->yieldContent('title_icon'); ?></span><?php endif; ?>
                <?php echo $__env->yieldContent('page_title', 'Tableau de bord'); ?>
            </h1>
        </div>
        ...
        <main class="ps-content">
            ...
            <?php if(session('error')): ?>
                <div class="ps-alert ps-alert-danger"><span>✕</span> <?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
...
<?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/admin/layouts/prestashop.blade.php ENDPATH**/ ?>