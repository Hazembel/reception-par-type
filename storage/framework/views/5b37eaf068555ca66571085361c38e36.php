...
<div class="pt-20 pb-16 max-w-3xl mx-auto px-4 sm:px-6">
    <h1 class="font-display text-2xl text-slate-900 dark:text-white mb-8"><?php echo e($meta_title ?? __('app.legal.terms_title')); ?></h1>
    ...
    <div class="prose dark:prose-invert text-slate-600 dark:text-slate-300 text-sm space-y-8">
        ...
        <section>
            ...
            <p>
                Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme <strong>reception-par-type.ch</strong>, exploitée par <?php echo e(\App\Models\Setting::get('company_name', 'reception-par-type.ch Sàrl')); ?>, <?php echo e(\App\Models\Setting::get('company_address', 'Rue de Genève 1')); ?>, <?php echo e(\App\Models\Setting::get('company_postal', 'CH-1003')); ?> <?php echo e(\App\Models\Setting::get('company_city', 'Lausanne')); ?>, Suisse (ci-après « l'Éditeur »).
            </p>
            <p class="mt-2">
        ...
        <section>
            ...
            <p>
                ...
                <a href="<?php echo e(route('privacy', ['locale' => app()->getLocale()])); ?>" class="text-blue-600 dark:text-blue-400">Politique de confidentialité</a>,
        ...
        <section>
            ...
            <p>
                ...
                <?php echo e(\App\Models\Setting::get('company_name', 'reception-par-type.ch Sàrl')); ?>, <?php echo e(\App\Models\Setting::get('company_address', 'Rue de Genève 1')); ?>, <?php echo e(\App\Models\Setting::get('company_postal', 'CH-1003')); ?> <?php echo e(\App\Models\Setting::get('company_city', 'Lausanne')); ?>, Suisse
            </p>
        </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/legal/terms.blade.php ENDPATH**/ ?>