...
<div class="min-h-screen flex items-center justify-center py-16 px-4
    ...
    <div class="w-full max-w-md mx-auto">
        <div class="overflow-hidden rounded-[2rem] bg-white/95 dark:bg-marine-900/80
            ...
            <form method="POST" action="<?php echo e(route('password.email', ['locale' => app()->getLocale()])); ?>" novalidate>
                <?php echo csrf_field(); ?>
                <div class="mb-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="mt-6 text-center text-xs text-slate-500 dark:text-slate-400">
                <a href="<?php echo e(route('login', ['locale' => app()->getLocale()])); ?>" class="font-medium text-blue-600 dark:text-astra hover:underline">Retour à la connexion</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>