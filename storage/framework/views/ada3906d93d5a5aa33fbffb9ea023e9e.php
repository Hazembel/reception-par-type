...
<div class="min-h-screen flex items-center justify-center py-16 px-4
    ...
    <div class="w-full max-w-md mx-auto">
        <div class="overflow-hidden rounded-[2rem] bg-white/95 dark:bg-marine-900/80
            ...
            <form method="POST" action="<?php echo e(route('login', ['locale' => app()->getLocale()])); ?>" novalidate>
                <?php echo csrf_field(); ?>

                
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
                        <?php echo e(__('app.auth.email')); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400/20 focus:border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-5" x-data="{ show: false }">
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
                        <?php echo e(__('app.auth.password')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DiskFiles\Projects\Web\upwork_Invoice_Ninja\reception-par-type\resources\views/auth/login.blade.php ENDPATH**/ ?>