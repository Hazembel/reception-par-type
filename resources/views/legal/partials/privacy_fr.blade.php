...
<section>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-xs border-collapse mt-2">
            ...
            <tbody>
                <tr><td class="p-2 border border-slate-200 dark:border-slate-700">Fourniture du service</td><td class="p-2 border border-slate-200 dark:border-slate-700">Art. 6(1)(b) — exécution du contrat</td></tr>
                <tr class="bg-slate-50 dark:bg-slate-900"><td class="p-2 border border-slate-200 dark:border-slate-700">Traitement des paiements et facturation</td><td class="p-2 border border-slate-200 dark:border-slate-700">Art. 6(1)(b) — exécution du contrat</td></tr>
                <tr><td class="p-2 border border-slate-200 dark:border-slate-700">Obligations légales (conservation des factures)</td><td class="p-2 border border-slate-200 dark:border-slate-700">Art. 6(1)(c) — obligation légale</td></tr>
                <tr class="bg-slate-50 dark:bg-slate-900"><td class="p-2 border border-slate-200 dark:border-slate-700">Sécurité et prévention de la fraude</td><td class="p-2 border border-slate-200 dark:border-slate-700">Art. 6(1)(f) — intérêt légitime</td></tr>
                <tr><td class="p-2 border border-slate-200 dark:border-slate-700">Gestion du programme d'affiliation</td><td class="p-2 border border-slate-200 dark:border-slate-700">Art. 6(1)(b) — exécution du contrat</td></tr>
            </tbody>
        </table>
    </div>
</section>
...
<section>
    ...
    <ul class="mt-2 space-y-2 list-disc list-inside">
        <li><strong>PayPal</strong> — traitement des paiements. <a href="https://www.paypal.com/fr/webapps/mpp/ua/privacy-full" target="_blank" rel="noopener" class="text-blue-600 dark:text-blue-400">Politique de confidentialité PayPal</a></li>
        <li><strong>Hébergeur</strong> — prestataire d'hébergement des serveurs (Europe)</li>
        <li><strong>OFROU/ASTRA</strong> — source des données techniques des véhicules (aucun transfert de données utilisateurs)</li>
    </ul>
...
<section>
    ...
    <p>Nos serveurs sont situés en Europe. Les paiements sont traités par PayPal (établi au Luxembourg, UE). En dehors de PayPal, vos données ne sont pas transférées hors de la Suisse ou de l'Espace économique européen.</p>
</section>
...
<section>
    ...
    <p class="mt-3">
        Pour exercer vos droits : <a href="mailto:admin@reception-par-type.ch" class="text-blue-600 dark:text-blue-400">admin@reception-par-type.ch</a><br>
        Nous répondons dans un délai de 30 jours. En cas de litige, vous pouvez déposer une plainte auprès du <a href="https://www.edoeb.admin.ch" target="_blank" rel="noopener" class="text-blue-600 dark:text-blue-400">Préposé fédéral à la protection des données (PFPDT)</a>.
    </p>
</section>

<section>
    <h2 class="text-base font-semibold text-slate-800 dark:text-slate-200 mb-3">Sécurité</h2>
    <p>Nous appliquons des mesures techniques et organisationnelles appropriées : chiffrement HTTPS (TLS), hachage des mots de passe (bcrypt), protection CSRF, contrôle d'accès par rôle. Signalez toute anomalie à <a href="mailto:admin@reception-par-type.ch" class="text-blue-600 dark:text-blue-400">admin@reception-par-type.ch</a>.</p>
</section>

<section>
    <h2 class="text-base font-semibold text-slate-800 dark:text-slate-200 mb-3">Modifications</h2>
    <p>Nous nous réservons le droit de modifier cette politique à tout moment. En cas de modification substantielle, les utilisateurs disposant d'un compte seront informés par e-mail. La version en vigueur est toujours accessible à cette adresse.</p>
</section>
