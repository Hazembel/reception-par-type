...
<div class="min-h-screen flex items-center justify-center py-16 px-4
    ...
    <div class="w-full max-w-md mx-auto">
        <div class="overflow-hidden rounded-[2rem] bg-white/95 dark:bg-marine-900/80
            ...
            <form method="POST" action="{{ route('register', ['locale' => app()->getLocale()]) }}" novalidate>
                @csrf
            ...
            <p class="mt-6 text-center text-xs text-slate-500 dark:text-slate-400">
                Déjà un compte ?
                <a href="{{ route('login', ['locale' => app()->getLocale()]) }}" class="font-medium text-blue-600 dark:text-astra hover:underline">Se connecter</a>
            </p>
        </div>
    </div>
</div>
